...
## [2.18.0](https://github.com/9000000/aiometadata/compare/v2.17.2...v2.18.0) (2026-09-13)


### Features

* add floating Google Translate widget with React DOM safety patch ([6999327](https://github.com/9000000/aiometadata/commit/6999327a92e9f004031e2f5aa1271f71b33a01a0))
* add PREFER_SMALLER_POSTERS_TMDB toggle ([d9387b2](https://github.com/9000000/aiometadata/commit/d9387b2ad657acaddea4694013c0ee9d46ef1a97))
* add PREFER_SMALLER_POSTERS_TMDB toggle ([51d3401](https://github.com/9000000/aiometadata/commit/51d3401ed67f4c72a33ee5141f58eba16c5ceffd))
* add streaming services, catalog types, and corresponding asset icons ([1409b69](https://github.com/9000000/aiometadata/commit/1409b697698db450b3747b812c2f8d827e869770))
* **aiomanager:** offer the sync button in the reinstall notice ([5095606](https://github.com/9000000/aiometadata/commit/5095606460744f3e5ace7a4e5296fd194fa64fe4))
* **aiomanager:** show the sync button where Hydra is available ([ca7371e](https://github.com/9000000/aiometadata/commit/ca7371ed729b9e2e735b77ddc6c11788e34cceff))
* **aliases:** resolve human-readable user aliases to UUIDs ([6dbd084](https://github.com/9000000/aiometadata/commit/6dbd084dcd624315688d05801103ef8b4525cad3))
* **aliases:** resolve human-readable user aliases to UUIDs ([5cc40bd](https://github.com/9000000/aiometadata/commit/5cc40bd7a8062c8b2ddc04f5f77acfc31b13f059))
* allow for per-provider policies in proxy-only environments ([9e50b45](https://github.com/9000000/aiometadata/commit/9e50b45e7e96db9308ff4aad267c93193687d177))
* allow for per-provider policies in proxy-only environments ([e8a85fc](https://github.com/9000000/aiometadata/commit/e8a85fcb82751a66f0c693863a02be9d03265131))
* **anime:** backfill anime id mappings from animeApi ([b58d50c](https://github.com/9000000/aiometadata/commit/b58d50ccb279274a2ff992c5303e25a8f0705a31))
* **anime:** fall back to the anidb bridge when kitsu-imdb has no entry ([1f9a059](https://github.com/9000000/aiometadata/commit/1f9a0595120aa5766ffd4ab5a3c92531d729729d))
* **art proxy:** guard the passthrough and follow the provider's own validity ([acd7b93](https://github.com/9000000/aiometadata/commit/acd7b934f5200ff21628f3a5d38b0c61747afe1d))
* **art proxy:** read CDN-Cache-Control and split the two cache audiences ([baa2309](https://github.com/9000000/aiometadata/commit/baa2309885c55c46cba4180120188f68c63e33fa))
* **art:** add landscape url patterns option ([a33d1b7](https://github.com/9000000/aiometadata/commit/a33d1b70d39e571552dd8b789a2230af0bdf60ea))
* **auth:** add OpenID Connect sign-in ([3af2e06](https://github.com/9000000/aiometadata/commit/3af2e0604af8e67528c67d64a5ae453845528e7c))
* **auth:** let an administrator session reach the dashboard ([3af2e06](https://github.com/9000000/aiometadata/commit/3af2e0604af8e67528c67d64a5ae453845528e7c))
* **auth:** open a configuration saved to an account without its password ([3af2e06](https://github.com/9000000/aiometadata/commit/3af2e0604af8e67528c67d64a5ae453845528e7c))
* **auth:** require signing in to reach the config page and its API ([ea8983c](https://github.com/9000000/aiometadata/commit/ea8983cbddebdc0f44fdf9a8c44c05934f97042d))
* **auth:** sign in with an identity provider and reach your configurations ([3af2e06](https://github.com/9000000/aiometadata/commit/3af2e0604af8e67528c67d64a5ae453845528e7c))
* **builder:** collapse the advisory banners into one status bar ([47ae36d](https://github.com/9000000/aiometadata/commit/47ae36dc11cfde57deb3f27555bf22e6cfa49368))
* **builder:** give the builder a full-screen shell with a pinned footer ([204fab9](https://github.com/9000000/aiometadata/commit/204fab991ce5601d08394ab0b9c95fedb7b8302d))
* **builder:** put folders in the rail and lift selection to the dialog ([0f51ed2](https://github.com/9000000/aiometadata/commit/0f51ed2d081f7c2dbad09f60b0d327d0fadf43f3))
* **builder:** report which folders a rail query matched ([f6581fb](https://github.com/9000000/aiometadata/commit/f6581fb4cfa1213880f63c443438f45b3afda245))
* cache cast photos through the poster cache ([f39af09](https://github.com/9000000/aiometadata/commit/f39af09b8dc3c7e48f0aaeb2d8f13aa1616cdb8e))
* cache cast photos through the poster cache ([c70d3ec](https://github.com/9000000/aiometadata/commit/c70d3ec74c740c840d2bf2b49a54b11c1339005e))
* **catalogs:** add a back to top button ([bc78e94](https://github.com/9000000/aiometadata/commit/bc78e946fe4d2e2e7179594a821180043874b3cf))
* **catalogs:** allow a per-catalog override of the digital release filter ([dbe40ed](https://github.com/9000000/aiometadata/commit/dbe40ed200945b3df3e2a728b8f232712438a304))
* **catalogs:** cap the content rating from the install url ([10b625c](https://github.com/9000000/aiometadata/commit/10b625cd2149eba71e2a7e1910d8e33562d5a096)), closes [#676](https://github.com/9000000/aiometadata/issues/676)
* **catalogs:** filter the list by whether a catalog is in a collection ([4f4f15c](https://github.com/9000000/aiometadata/commit/4f4f15c37fe0e3de6eae833b1aabdfd7ddc1be4c))
* **catalogs:** import and remap existing collection files ([cef456f](https://github.com/9000000/aiometadata/commit/cef456fd39a77c4a2a9e2c9af3ec34cb861df2fd))
* **catalogs:** integrate Rotten Tomatoes catalogs and UI picker dialog ([2f69252](https://github.com/9000000/aiometadata/commit/2f69252d2b3c8c53ec9438c66f36a246b178579c))
* **catalogs:** serve collection and widget JSON over HTTP ([cef456f](https://github.com/9000000/aiometadata/commit/cef456fd39a77c4a2a9e2c9af3ec34cb861df2fd))
* **catalogs:** set or reset a catalog's cache TTL in bulk ([59857cd](https://github.com/9000000/aiometadata/commit/59857cd59479842203767c334b41311ef8bd1134))
* **catalogs:** visual builder for Nuvio collections and Fusion widgets ([cef456f](https://github.com/9000000/aiometadata/commit/cef456fd39a77c4a2a9e2c9af3ec34cb861df2fd))
* **collections:** browse featured collections in their own tab ([fa62b33](https://github.com/9000000/aiometadata/commit/fa62b336ebde812f318e2fdf5198745ee10265d1))
* **collections:** browse featured collections in their own tab ([8a8fb29](https://github.com/9000000/aiometadata/commit/8a8fb297fb79b760eb92871538d57d6b8454b774))
* **collections:** carry a catalog's own type through an export so an import can match it ([0f96c15](https://github.com/9000000/aiometadata/commit/0f96c15d8c93d86abd53a88c927153c350c33957))
* **collections:** carry Fusion's own Trakt list sources ([ba84f88](https://github.com/9000000/aiometadata/commit/ba84f88826de4ae388edefa05e1921fb0f28f2d1))
* **collections:** derive one save stage for the builder ([b5d5993](https://github.com/9000000/aiometadata/commit/b5d599318f6ff8ba9d76ef69c9608ceca3720b74))
* **collections:** dock the preview beside the editor on wide screens ([9f495c1](https://github.com/9000000/aiometadata/commit/9f495c1fb8f846dfd4822e0753c9497cd223537b))
* **collections:** duplicate a collection or folder, and jump one to either end ([c0fcfb7](https://github.com/9000000/aiometadata/commit/c0fcfb70edc34e821fa53d1ee94e2000ffe43cf8))
* **collections:** featured collections in the builder ([8b2ae5b](https://github.com/9000000/aiometadata/commit/8b2ae5b72f240a964c4a8ebfadce512850b1eb43))
* **collections:** featured collections in the builder ([121abae](https://github.com/9000000/aiometadata/commit/121abae8b61014371484f41731ea06381c0c3752))
* **collections:** filter, key through and bulk-pick catalogs ([e394b49](https://github.com/9000000/aiometadata/commit/e394b49328a5045b969c099852a7e68ed95520c0))
* **collections:** give the entry rail room to read and a filter ([1c62954](https://github.com/9000000/aiometadata/commit/1c62954463ecaad36dafa2da7cf14b6940130a69))
* **collections:** label an excluded entry instead of only dimming it ([7c595c8](https://github.com/9000000/aiometadata/commit/7c595c8dc7aa56b3bc1fa1c91f8862864e6e6917))
* **collections:** make deleting undoable and confirm a replacing import ([dd7d833](https://github.com/9000000/aiometadata/commit/dd7d833165239a212d0116e94aeafa0eb4371eb9))
* **collections:** make the builder a full-height sheet on small screens ([4045049](https://github.com/9000000/aiometadata/commit/4045049a77e661ce1feeb1fe6c9e8d5fab2c7618))
* **collections:** merge an imported file into what it shares an id with ([6b4adca](https://github.com/9000000/aiometadata/commit/6b4adca4d56c1276490f987d4f6288c28a587121))
* **collections:** name the addons an exported file needs installed ([f7bcd94](https://github.com/9000000/aiometadata/commit/f7bcd9487ee5462f593d879243a9d1c18676b027))
* **collections:** name the same thing the same way on both targets ([519f3db](https://github.com/9000000/aiometadata/commit/519f3db3ab4ff23f1cffcb05f6102e03cd26f579))
* **collections:** number repeated copies instead of stacking the word ([f26d870](https://github.com/9000000/aiometadata/commit/f26d8707041f7fd710742034e78748420b016424))
* **collections:** offer starter layouts instead of an empty rail ([9ce58b7](https://github.com/9000000/aiometadata/commit/9ce58b7e1bf6a8b5e1587fc02160d54e91e86f68))
* **collections:** preview a classic row at its real card geometry ([c4a1d51](https://github.com/9000000/aiometadata/commit/c4a1d5125a1aa481d6f2a814627779873ce13208))
* **collections:** preview a collection as the tiles it becomes ([0a95be4](https://github.com/9000000/aiometadata/commit/0a95be47cd9a26e6a035eaf69f0c2dd66c75273d))
* **collections:** preview a collection the way Fusion will draw it ([251ec0b](https://github.com/9000000/aiometadata/commit/251ec0ba17e36bd101241f8185505ff4b655f32e))
* **collections:** put the manifest source where it can be acted on ([2ad390e](https://github.com/9000000/aiometadata/commit/2ad390efa77d20190834c6ca9ef12bd207fa7710))
* **collections:** rank builder problems by severity ([82884a3](https://github.com/9000000/aiometadata/commit/82884a37016a11327b531ffe291b1d37e2f58d25))
* **collections:** rename a catalog from its source row ([87aa568](https://github.com/9000000/aiometadata/commit/87aa568e2772c9b953a66c6042b4f7f23d4537f9))
* **collections:** rename a catalog from its source row ([f8b8e4b](https://github.com/9000000/aiometadata/commit/f8b8e4b433c616c1dcd5727d6aa6a1ed07911b1d))
* **collections:** reorder the catalogs inside a folder ([b01b0fe](https://github.com/9000000/aiometadata/commit/b01b0fee0e3f3e2250847883ac6d03bf460d3cf3))
* **collections:** rework the builder into panes with a ranked issue list ([4308a7a](https://github.com/9000000/aiometadata/commit/4308a7a30dd95808ca32bd68d77a0a3e9a328182))
* **collections:** save the builder in one step instead of three ([ae3e281](https://github.com/9000000/aiometadata/commit/ae3e281f4244bc36cebaaaaf856b7f9874158cbd))
* **collections:** search provider lists from the catalog picker ([9da47b6](https://github.com/9000000/aiometadata/commit/9da47b68b9c6af6a47a9b13f0f903b88123fd8cf))
* **collections:** serve a catalog preview the browser can read ([a7c8462](https://github.com/9000000/aiometadata/commit/a7c8462b4a6bdec8bc2f2786192e669777a73c2a))
* **collections:** serve a catalog preview the browser can read ([47e9b41](https://github.com/9000000/aiometadata/commit/47e9b41f8562d798a51a5746946521d17640daa5))
* **collections:** show a real preview and reach the menu by press ([0207079](https://github.com/9000000/aiometadata/commit/0207079e740d4595d1677a0fe6bfd72a64b9212c))
* **collections:** show a real preview and reach the menu by press ([8d5c93d](https://github.com/9000000/aiometadata/commit/8d5c93d45209d13b11c3c4b8d7c702a129d301ae))
* **collections:** show export problems next to the design that causes them ([d50e065](https://github.com/9000000/aiometadata/commit/d50e065fd42da3fea2a21440ec2e02c0932031af))
* **collections:** show one ranked issue list and put its verdict on save ([32769bf](https://github.com/9000000/aiometadata/commit/32769bf141632be1b444e4dc951fdcac4f048655))
* **collections:** warn on a classic row whose type Fusion will not import ([bf8d979](https://github.com/9000000/aiometadata/commit/bf8d97939ba40d963158dc9648d9d88ebfea92eb))
* **config:** add built-in MDBList and Gemini keys ([c5be0db](https://github.com/9000000/aiometadata/commit/c5be0db1add0d5cf983ea3b325653db829eef3c5))
* **config:** import a configuration from a link ([f37de15](https://github.com/9000000/aiometadata/commit/f37de156f8028c7059d11ba91e7c3c588b6d3425))
* **configure:** add the timezones the backend already maps ([238616d](https://github.com/9000000/aiometadata/commit/238616df3e50455f109c536f1713fda9f4f8d59e))
* **configure:** add the timezones the backend already maps ([610c9f1](https://github.com/9000000/aiometadata/commit/610c9f11e688c089a4d085beaa88430709003a0f))
* **dashboard:** add an accounts panel for identity provider sign-ins ([c4f5946](https://github.com/9000000/aiometadata/commit/c4f59466a3c071381bd269531b9fba4774dde7df))
* **dashboard:** add LOG_QUERY_MAX_ENTRIES and LOG_VIEWER_MAX_ENTRIES settings ([440856b](https://github.com/9000000/aiometadata/commit/440856bbdd8d9201b4e883be9dca6c5e8d8c3df9))
* **diagnostics:** enable Redis command tracker and periodic reporting ([619f6d5](https://github.com/9000000/aiometadata/commit/619f6d5dc9940abd4a24c92c1597575a472ff6d8))
* **discover:** add Today and This Week date presets ([2a7d3d1](https://github.com/9000000/aiometadata/commit/2a7d3d1861e9bc45314b291578f23216f511b8ad))
* **discover:** filter movies by TMDB release type ([15fd9f1](https://github.com/9000000/aiometadata/commit/15fd9f19dac6093c9cf5c5c63868e8c4d3a59be0)), closes [#642](https://github.com/9000000/aiometadata/issues/642)
* **discover:** filter series by TMDB show type ([513c5f5](https://github.com/9000000/aiometadata/commit/513c5f585f21ec5ed39f4114f20131adead2e7ae)), closes [#636](https://github.com/9000000/aiometadata/issues/636)
* **filters:** hide watched items from Simkl ([dbe40ed](https://github.com/9000000/aiometadata/commit/dbe40ed200945b3df3e2a728b8f232712438a304))
* **filters:** let a content rating keep unrated titles ([38e7588](https://github.com/9000000/aiometadata/commit/38e7588beff264443091675398f547e4eb6b3d30))
* **franchise:** add auto-sync workflow and in-memory runtime updater for Koyeb ([530bda9](https://github.com/9000000/aiometadata/commit/530bda95dd66ab535b813d6f5ef43d8240338955))
* **health:** probe dependencies on the readiness endpoint ([ecb9cf4](https://github.com/9000000/aiometadata/commit/ecb9cf49252d3037a381d305938e827adda58c6e))
* Hide Stremio-specific catalogs ([d13e887](https://github.com/9000000/aiometadata/commit/d13e8878b0191487425d1fad775805f63afd3eed))
* Hide Stremio-specific catalogs ([fcef660](https://github.com/9000000/aiometadata/commit/fcef66005d35080e3d75ac649d8467044f326c77))
* **image cache:** add built-in provider policy ([b12ced8](https://github.com/9000000/aiometadata/commit/b12ced8c866cf9202f3891aeb41ab7eddc46fa8e))
* implement adaptive Jikan API request rate limiter and add LineupGallery component ([5a14d6f](https://github.com/9000000/aiometadata/commit/5a14d6fa3d877d3182695af7662317e28b873956))
* implement request tracking middleware and IMDb rating projection utilities ([c15e71c](https://github.com/9000000/aiometadata/commit/c15e71ce9ee6785f6bb6fdfa62fb816af0476544))
* **managers:** sync to several addon manager accounts ([64fa905](https://github.com/9000000/aiometadata/commit/64fa9050611d3b429f5bff2ac0ca4c6710d71d2d))
* **manifest:** install several tag profiles as one addon ([178438c](https://github.com/9000000/aiometadata/commit/178438cb49b045189a9a49a7f149742275a9cb89)), closes [#677](https://github.com/9000000/aiometadata/issues/677)
* **mdblist:** drop the cache TTL floor on watchlist and up next ([64983bb](https://github.com/9000000/aiometadata/commit/64983bb63cf397b11542106f732a1cca82e948a4))
* **mdblist:** let recommendations be added as movies or series ([a80a17c](https://github.com/9000000/aiometadata/commit/a80a17c69dbc4205ba4ba93fb85a3fc22cd56257)), closes [#650](https://github.com/9000000/aiometadata/issues/650)
* **mdblist:** offer score filters on every list catalog ([6f0bf01](https://github.com/9000000/aiometadata/commit/6f0bf0130f294191e5ed8656719a3440b7b637a8))
* **mdblist:** search public lists from the integration page ([44d6766](https://github.com/9000000/aiometadata/commit/44d6766a65bac9837d2fc256a71574fff7300a93))
* **mdblist:** use quick_search on the search endpoint ([2c1a481](https://github.com/9000000/aiometadata/commit/2c1a4810c1d9efb0650ece14b5014140866dfd60))
* **oidc:** refuse sign-ins outside the allowed email domains ([3bb4211](https://github.com/9000000/aiometadata/commit/3bb42114982bacb06ba962497ba0053c2312a42f))
* **search:** add IMDb suggestions as a typo tolerant search provider ([bda234f](https://github.com/9000000/aiometadata/commit/bda234f07c9f43b1dcb2dbf3970d257b12fb8e0a))
* **search:** add Simkl as a search provider ([9b39cd2](https://github.com/9000000/aiometadata/commit/9b39cd2af65658fbcd53994faca744357f34ea8c))
* **search:** add Simkl as an anime search provider ([73b25dd](https://github.com/9000000/aiometadata/commit/73b25dd7e490ae0ba29ec7881ba1b9eeaa03d051))
* **search:** build Simkl results from Simkl's own data ([cc1b345](https://github.com/9000000/aiometadata/commit/cc1b3453b8da751af9ffbcbb73d159e2544fee92))
* **search:** show when a show started and ended ([1338a92](https://github.com/9000000/aiometadata/commit/1338a9250f97ef4b06b28b13539966d9ef82455a))
* **settings:** add Redis logging and periodic reporting toggles to admin settings ([ba102a3](https://github.com/9000000/aiometadata/commit/ba102a32faffb0c8bd0a41ff1b911fe39d92fbf2))
* **settings:** make the MDBList list cache TTL configurable ([c6ee5be](https://github.com/9000000/aiometadata/commit/c6ee5be6b30b74b5f67fafef88fd53de0246e8c1))
* **settings:** register TMDB rendition toggles ([ab2ccc9](https://github.com/9000000/aiometadata/commit/ab2ccc9cdbccae0b19f1a6e16710fe70e4d78ce5))
* **settings:** regroup the dashboard settings and add a filter ([c6ee5be](https://github.com/9000000/aiometadata/commit/c6ee5be6b30b74b5f67fafef88fd53de0246e8c1))
* **setup:** rebuild the presets tab as a guided setup surface ([513a03a](https://github.com/9000000/aiometadata/commit/513a03af17e139bcb77ede8b93462a00cb43a594))
* **simkl:** add PIN authentication ([3bc40bf](https://github.com/9000000/aiometadata/commit/3bc40bf5a94d8a8a8c85054a7783e617b82ea67c))
* **simkl:** add PIN authentication ([118f374](https://github.com/9000000/aiometadata/commit/118f374f63d287cf2c606be650cdef335c729b20))
* **simkl:** add Up Next catalogs ([f3b68de](https://github.com/9000000/aiometadata/commit/f3b68ded4ff53d850ed179bd3316fc59e81d6edd))
* **sso:** apply group mapping changes to live sessions ([03e6b37](https://github.com/9000000/aiometadata/commit/03e6b3731884cfafa6393da9ae0ad765a2469875))
* **sso:** confirm settings changes that would remove your own access ([97c81e6](https://github.com/9000000/aiometadata/commit/97c81e61c479deeb5ef84832374423357fe973ac))
* **sso:** expose account sessions, configurations and deletion ([46328b8](https://github.com/9000000/aiometadata/commit/46328b8bc489f1f9f1b2a668d6bb8e3568afeadf))
* **sso:** let an admin revoke an account's sessions ([a180a7b](https://github.com/9000000/aiometadata/commit/a180a7be60599e4e9c467567d3b5639bbf6105e0))
* **tmdb:** add central image rendition helper ([dbea454](https://github.com/9000000/aiometadata/commit/dbea454aaa87606a5975cc222e1601e2c0a0d07e))
* **tmdb:** add TMDB collections as catalogs ([1854bf1](https://github.com/9000000/aiometadata/commit/1854bf12995e92a553d412eb3dd36a6b928b79da))
* **tmdb:** make all rendition toggles opt-in ([10c73b6](https://github.com/9000000/aiometadata/commit/10c73b6203d813de05c61d28e268011fb1359f5c))
* **tmdb:** size art-batch logos and backdrops via helper ([19479a9](https://github.com/9000000/aiometadata/commit/19479a9cfab0041626fe0b74718764f00cb2ecb0))
* **tmdb:** size landscape posters independently of backgrounds ([f9ce52d](https://github.com/9000000/aiometadata/commit/f9ce52d6249c3f856f9826c8b359bde520d9b050))
* **tmdb:** size meta logos and backdrops via helper ([7a95b05](https://github.com/9000000/aiometadata/commit/7a95b05a5d5f2b22ce483d7c0fddf2883c41f7cc))
* **tmdb:** size provider logos and backdrops via helper ([cc0848a](https://github.com/9000000/aiometadata/commit/cc0848a71dbc8248cac45dea69f0f9d90675a3c9))
* **tmdb:** size search logos and backdrops via helper ([bc514d4](https://github.com/9000000/aiometadata/commit/bc514d469ecbf11689cb70e1e707c44cfd8913cc))
* **tracking:** point users at the login when they enable watch tracking ([c38d88b](https://github.com/9000000/aiometadata/commit/c38d88b96967f013bfc9400c09d4a6be65256493))
* **tvdb:** add TheTVDB lists as catalogs ([8676f57](https://github.com/9000000/aiometadata/commit/8676f5782180b8e1558bd78e588f44513352e16f))
* **ui:** save from any settings section ([31f9540](https://github.com/9000000/aiometadata/commit/31f9540f3a41d14ef3fd7fd3653c3e6a9f34d5ff))
* **ui:** update franchise collections icon to superhero emblem ([bd25efc](https://github.com/9000000/aiometadata/commit/bd25efc92b8deb96f44096dd0b65a87259e18059))
* **ui:** update streaming providers icon ([7dd657e](https://github.com/9000000/aiometadata/commit/7dd657eca0b7fe83ed0d5eafd93d3a75311ed22a))
* **users:** track user requests, last activity, and calculate active status accurately ([aec4d2c](https://github.com/9000000/aiometadata/commit/aec4d2ce01bdf6e821cc865975d7817d4ea75d69))
* **warming:** add a sync TTL action to the catalog warming task ([5f6c6a9](https://github.com/9000000/aiometadata/commit/5f6c6a9166ef72902a8a12592eb0970f48f36f99))
* **warmup:** break the image warm summary down by image class ([b27f88c](https://github.com/9000000/aiometadata/commit/b27f88c2235d4f6a68d7fe972dd6975c21e25543))
* **watch-tracking:** record from real playback where a client reports it ([0b70cb4](https://github.com/9000000/aiometadata/commit/0b70cb42cbd769da134372a4f2d30397c557e853))


### Bug Fixes

* **admin:** require authentication on every admin route ([3af2e06](https://github.com/9000000/aiometadata/commit/3af2e0604af8e67528c67d64a5ae453845528e7c))
* **admin:** serve the user export route before the :userUUID wildcard ([86281f4](https://github.com/9000000/aiometadata/commit/86281f406bccd20917b0b63cc4cdcd600d6fc527))
* **aliases:** back off the alias map refresh after a failed load ([4a34119](https://github.com/9000000/aiometadata/commit/4a3411992fdc3f65e62a6a52c05da1b442076c3b))
* **aliases:** hide alias controls when the feature is disabled ([4a34119](https://github.com/9000000/aiometadata/commit/4a3411992fdc3f65e62a6a52c05da1b442076c3b))
* **aliases:** keep a missing user_aliases table from breaking the user list ([4a34119](https://github.com/9000000/aiometadata/commit/4a3411992fdc3f65e62a6a52c05da1b442076c3b))
* **aliases:** preserve query string encoding when rewriting userUUID ([4a34119](https://github.com/9000000/aiometadata/commit/4a3411992fdc3f65e62a6a52c05da1b442076c3b))
* **aliases:** read CONFIG_LOAD_RATE_LIMIT_PER_MIN from the settings registry ([4a34119](https://github.com/9000000/aiometadata/commit/4a3411992fdc3f65e62a6a52c05da1b442076c3b))
* **aliases:** require ADMIN_KEY for alias changes ([4a34119](https://github.com/9000000/aiometadata/commit/4a3411992fdc3f65e62a6a52c05da1b442076c3b))
* **aliases:** resolve aliases on /api/config/clear-cache ([4a34119](https://github.com/9000000/aiometadata/commit/4a3411992fdc3f65e62a6a52c05da1b442076c3b))
* **anilist:** read a named user's lists with an account token ([fff67be](https://github.com/9000000/aiometadata/commit/fff67be1b83afc7ec793fec68fe8a1916238560a))
* **anilist:** resolve an account token for studio search and previews ([43469e2](https://github.com/9000000/aiometadata/commit/43469e2e1e086969f7f4b2859e2659bb861ceff7))
* **anilist:** send a referer so anonymous reads go through ([8d3a428](https://github.com/9000000/aiometadata/commit/8d3a4283653dcde03cd95c8aa8adf2e0c3b0b759))
* **anime:** fetch release dates regardless of the digital release filter ([dbe40ed](https://github.com/9000000/aiometadata/commit/dbe40ed200945b3df3e2a728b8f232712438a304))
* **anime:** honour a zero delay instead of treating it as unset ([638d5da](https://github.com/9000000/aiometadata/commit/638d5da5566869d2e608de92c40e01e4890cbd71))
* **anime:** list episodes for MAL titles that carry only a count ([b4b4668](https://github.com/9000000/aiometadata/commit/b4b4668840b47cd0b4243b531efb281cb65d4d37))
* **anime:** repair the kitsu to imdb mapping ([1f9a059](https://github.com/9000000/aiometadata/commit/1f9a0595120aa5766ffd4ab5a3c92531d729729d))
* **anime:** stop calling multi-episode ONAs movies ([ad31847](https://github.com/9000000/aiometadata/commit/ad31847d166989cca537ff4893690478f7ebd83e))
* **art proxy:** answer 404 when the poster proxy has no fallback to redirect to ([90dd65d](https://github.com/9000000/aiometadata/commit/90dd65d1cf17386d844ce6eff3715035d4c0bc52))
* **art proxy:** relay the provider's CDN-Cache-Control when following it ([9c6a829](https://github.com/9000000/aiometadata/commit/9c6a829132bd3d7643ccecb5fcd2dd09d0d54fb5))
* **art proxy:** relay the provider's CDN-Cache-Control when following it ([b2e8f68](https://github.com/9000000/aiometadata/commit/b2e8f68ce50b311c79548b59a4e1e929efce9fe2))
* **art proxy:** stop overriding the client and CDN cache contract ([3c5583f](https://github.com/9000000/aiometadata/commit/3c5583f5df49c02ca5d871fd4283a808681c9bb7))
* **auth:** keep the auth endpoints out of caches ([7b3c67c](https://github.com/9000000/aiometadata/commit/7b3c67cc44ba000cc0c78d3821f3e772908d26d9))
* **builder:** act on the real folder index when the rail is filtered ([3255983](https://github.com/9000000/aiometadata/commit/32559832efd579a39ae34bf0681a5694fef8540d))
* **builder:** drop the breadcrumb when nothing is selected ([e54a9d9](https://github.com/9000000/aiometadata/commit/e54a9d91f19429c5aae29e25d88d1c3ca275e414))
* **builder:** drop the dialog padding above the small breakpoint ([6b55b5d](https://github.com/9000000/aiometadata/commit/6b55b5d0691e7d9b498dd7b43abd173dec67f972))
* **builder:** expand the selected entry when the dialog reopens ([b1d5988](https://github.com/9000000/aiometadata/commit/b1d5988ba47c176f3572fe0f801ed7abed17561e))
* **builder:** focus the title of a folder you just added ([3d92d2e](https://github.com/9000000/aiometadata/commit/3d92d2e4751d64245fe0a55c7b1995c8bedaa68d))
* **builder:** give the footer and the editor a container to query ([e9b2c68](https://github.com/9000000/aiometadata/commit/e9b2c68387e4c086a22588ff20e4e422e7f02e26))
* **builder:** keep the preview reachable below the widest layout ([45c492f](https://github.com/9000000/aiometadata/commit/45c492f7c9b91fdc156f3c858b03960602429961))
* **builder:** let a folder drag land in another collection ([ab0ee6c](https://github.com/9000000/aiometadata/commit/ab0ee6c5514b78214f1a1b5c6769bb4d8522cf6d))
* **builder:** let folder rows reorder by drag again ([acb6251](https://github.com/9000000/aiometadata/commit/acb6251e8707525017c8fb0bca7243595df9fd5e))
* **builder:** restore preview section & un-truncate catalog names ([fccb85e](https://github.com/9000000/aiometadata/commit/fccb85e36dc6900842a82b5dc5a1434051a8831c))
* **builder:** show the folders the rail filter matched ([a7e1ac2](https://github.com/9000000/aiometadata/commit/a7e1ac29e5870ce2fde2f6682d2214e652c2aed5))
* **builder:** show the row controls where nothing can hover ([53f8c07](https://github.com/9000000/aiometadata/commit/53f8c07d61bf855e76e76e36841ff5ab9fa3f3d8))
* **builder:** stop source row meta overflowing the delete button ([82a6414](https://github.com/9000000/aiometadata/commit/82a641473f96b7cc6efa0600071b52daa166c64a))
* **builder:** stop the header and footer crowding out the panes ([01feef5](https://github.com/9000000/aiometadata/commit/01feef56f00f16f3606db8eae360f967e68768d4))
* **cache:** bump the cache epoch so the id fixes take effect ([b0da330](https://github.com/9000000/aiometadata/commit/b0da3304ee58ff3ff5c4a534ebe5e38cb9736135))
* **cache:** fetch only the art when a user's art profile has none for a cached meta ([02262d9](https://github.com/9000000/aiometadata/commit/02262d97c421e65fdbcd3bcb5f2a9d6ae07bc67f))
* **cache:** give a background rebuild a cost ceiling ([dd17ee0](https://github.com/9000000/aiometadata/commit/dd17ee09a98522acd023dc90604ac52c0ab7822b))
* **cache:** give anilist.discover catalogs their discover signature ([c0ef296](https://github.com/9000000/aiometadata/commit/c0ef296e5b5fb9892b4ba1893c3fa75f8b7a8904))
* **cache:** honour a zero cache TTL for every catalog source ([316276c](https://github.com/9000000/aiometadata/commit/316276cc33ab407c45178daa60b8f2d5efdc4c15))
* **cache:** keep discover cache keys stable across local midnight ([c0ef296](https://github.com/9000000/aiometadata/commit/c0ef296e5b5fb9892b4ba1893c3fa75f8b7a8904))
* **cache:** keep warmed catalogs for their full window ([c50e7b0](https://github.com/9000000/aiometadata/commit/c50e7b00e93816cf4ab625cffd61b1a744476abb))
* **cache:** key anime-detected metas on the anime settings ([633b7c8](https://github.com/9000000/aiometadata/commit/633b7c8a1e1af42c8d7618b22dd987078ff4f4e3))
* **cache:** key MDBList discover results by their TTL ([316276c](https://github.com/9000000/aiometadata/commit/316276cc33ab407c45178daa60b8f2d5efdc4c15))
* **cache:** let a refresh update an entry but never recreate it ([b2b457f](https://github.com/9000000/aiometadata/commit/b2b457f282d2faaf62a1aa3f7cec1c8094644d0b))
* **cache:** match catalog TTL override by id and type ([c1ad25e](https://github.com/9000000/aiometadata/commit/c1ad25ee76ade7b8019347923dd6aca8f1a1fc70))
* **cache:** match catalog TTL override by id and type ([8ea6b91](https://github.com/9000000/aiometadata/commit/8ea6b91171826bc754cfe2f5f37af35ec3c97514))
* **cache:** pass the key to the classifier so a Jikan object is not read as empty ([114ff36](https://github.com/9000000/aiometadata/commit/114ff3676b3579b9afd7369de42f70cd0e42476f))
* **cache:** read the warming interval outside the scheduler ([1eed37f](https://github.com/9000000/aiometadata/commit/1eed37f6205ec98881a7167c8ed9b4946575614d))
* **cache:** refresh catalogs from their source instead of cache ([ab1a286](https://github.com/9000000/aiometadata/commit/ab1a286bada2ca98426bb1410e58bacda2cf4d93))
* **cache:** refresh catalogs from their source instead of cache ([b4616be](https://github.com/9000000/aiometadata/commit/b4616bef6f168f034007a8defa863f21b2991887))
* **cache:** refresh series metadata once an upcoming episode has aired ([6e7273a](https://github.com/9000000/aiometadata/commit/6e7273a664b576c4d2c2283cd5efd22115ac6ba3))
* **cache:** refresh series metadata once an upcoming episode has aired ([a8ffdc6](https://github.com/9000000/aiometadata/commit/a8ffdc6a93185e402e6b1e79ac709d948672b6be))
* **cache:** reuse meta components when a catalog id resolves to another id ([c0ef296](https://github.com/9000000/aiometadata/commit/c0ef296e5b5fb9892b4ba1893c3fa75f8b7a8904))
* **cache:** stop refreshing entries the classifier shortened ([8f33a45](https://github.com/9000000/aiometadata/commit/8f33a452ed0fc2d350b05441b0e9636c156c9ad1))
* **cache:** stop warmed catalogs from lapsing between warm runs ([c461acf](https://github.com/9000000/aiometadata/commit/c461acf84e3ad3dc292eb03dac9198600f4f035a))
* **catalogs:** allow hiding unreleased shows per catalog ([29ae080](https://github.com/9000000/aiometadata/commit/29ae080bfcde6e07f2a8b41899b4bbcc63bd1d96))
* **catalogs:** allow hiding unreleased shows per catalog ([3dfca7e](https://github.com/9000000/aiometadata/commit/3dfca7efacd2fc34c77a3d704f353cbe9d543c5b))
* **catalogs:** carry the age rating on anime catalog rows ([921dec3](https://github.com/9000000/aiometadata/commit/921dec3e4b5b3dd451fbf6b59787c42c781891bd)), closes [#704](https://github.com/9000000/aiometadata/issues/704)
* **catalogs:** carry the age rating on anime catalog rows ([118ec72](https://github.com/9000000/aiometadata/commit/118ec72dc572453e4bff9eb75500b7d5a68cfad1)), closes [#704](https://github.com/9000000/aiometadata/issues/704)
* **catalogs:** count a catalog as in a collection however the source spells it ([c8a7a52](https://github.com/9000000/aiometadata/commit/c8a7a522fd639d1352e0cd1c49f0f4bb8d3b8100))
* **catalogs:** fix tmdb.top series sort and remove restrictive regional monetization filter ([fbf7b94](https://github.com/9000000/aiometadata/commit/fbf7b94b3abe11fdf7beeca79cf2e031e8de8546))
* **catalogs:** honor the per-catalog cache TTL on PublicMetaDB catalogs ([d5699ba](https://github.com/9000000/aiometadata/commit/d5699bac2b7e5a8d30b42b969c5c682837a1ff7f))
* **catalogs:** keep paging a filtered catalog past an empty page ([39d2ca2](https://github.com/9000000/aiometadata/commit/39d2ca2454e1fa1408723b708a3b3a3ec80e6408))
* **catalogs:** keep tags when importing catalogs ([391207d](https://github.com/9000000/aiometadata/commit/391207d7fe4b746edc1d7d2ab408fca1aa5d32ef))
* **catalogs:** keep the catalog list responsive when it is long ([329c4b9](https://github.com/9000000/aiometadata/commit/329c4b94703ce463b3bc26756c07cc3ff50463e4))
* **catalogs:** keep the Home placement when a catalog is disabled ([1a6a060](https://github.com/9000000/aiometadata/commit/1a6a06034d0175551d3d76c1ddbe6c6a34f09219))
* **catalogs:** keep the local content rating on a cached row ([c862577](https://github.com/9000000/aiometadata/commit/c86257783ab5b035e4ba107a852e7f269b4d5f16))
* **catalogs:** make collection persistence and catalog warnings honest ([cef456f](https://github.com/9000000/aiometadata/commit/cef456fd39a77c4a2a9e2c9af3ec34cb861df2fd))
* **catalogs:** match tag names without regard to case ([391207d](https://github.com/9000000/aiometadata/commit/391207d7fe4b746edc1d7d2ab408fca1aa5d32ef))
* **catalogs:** re-read the catalog ceiling instead of trusting boot ([69c162c](https://github.com/9000000/aiometadata/commit/69c162c3350ba77cfc5efd095ec110840752959b))
* **catalogs:** re-read the catalog ceiling instead of trusting boot ([bf834f5](https://github.com/9000000/aiometadata/commit/bf834f55fec87ff7f4bf8b9c412d08c15575ec7a))
* **catalogs:** render only the catalog rows in view ([505d865](https://github.com/9000000/aiometadata/commit/505d865efedb28eb2a879f60890ba6840b959efd))
* **catalogs:** render only the catalog rows in view ([ec2662b](https://github.com/9000000/aiometadata/commit/ec2662b5cf81547967a60a5e3201fcc2978a2ea5))
* **catalogs:** request media type for split MDBList watchlists ([0261115](https://github.com/9000000/aiometadata/commit/02611155ff2e6b74129aaf582d805cd312a4de45)), closes [#687](https://github.com/9000000/aiometadata/issues/687)
* **catalogs:** request media type for split MDBList watchlists ([0b2fbcc](https://github.com/9000000/aiometadata/commit/0b2fbccdae671fbdbc1da45711b0c7c6939f84e6)), closes [#687](https://github.com/9000000/aiometadata/issues/687)
* **catalogs:** resolve a catalog whose display type suffix is _all ([eaade76](https://github.com/9000000/aiometadata/commit/eaade76900520bdf9000654f8cc3e3bce66813d7))
* **catalogs:** stop copying the instance cache TTL onto new catalogs ([59857cd](https://github.com/9000000/aiometadata/commit/59857cd59479842203767c334b41311ef8bd1134))
* **catalogs:** warn when deleting a catalog a collection uses ([99c520d](https://github.com/9000000/aiometadata/commit/99c520d7dd87703e4145cbc1233345e8dd06d643))
* **ci:** build the release image from release-please instead of by hand ([b759366](https://github.com/9000000/aiometadata/commit/b759366de03687391e9338ce5f59d2e35355f3be))
* **ci:** tag release images with the semver version ([bd8a359](https://github.com/9000000/aiometadata/commit/bd8a3595bc02df5805b960f95f0b819ab4780643))
* **ci:** tag release images with the semver version ([2380422](https://github.com/9000000/aiometadata/commit/23804223ad7b17a8dcf6d2dd1ead96c7ec57a58e))
* **collections:** apply the digital release and unknown-source checks to the right sources ([329c4b9](https://github.com/9000000/aiometadata/commit/329c4b94703ce463b3bc26756c07cc3ff50463e4))
* **collections:** carry a merge's parts so it rebuilds on import ([415867c](https://github.com/9000000/aiometadata/commit/415867c1305489dedca61c5b165db03b47284edf))
* **collections:** carry a source genre through the Fusion export and back ([da2a388](https://github.com/9000000/aiometadata/commit/da2a388bc48a3cc12d534494b6f75ca3b5a3da2e))
* **collections:** carry catalogs with a shared collection ([329c4b9](https://github.com/9000000/aiometadata/commit/329c4b94703ce463b3bc26756c07cc3ff50463e4))
* **collections:** drop the resets for state the save mode replaced ([598baac](https://github.com/9000000/aiometadata/commit/598baaca712b79609768e332ccfc8712c01667a8))
* **collections:** embed catalog definitions in the exported collections ([329c4b9](https://github.com/9000000/aiometadata/commit/329c4b94703ce463b3bc26756c07cc3ff50463e4))
* **collections:** give an imported entry a free id when the file's is taken ([d6165c5](https://github.com/9000000/aiometadata/commit/d6165c562f3f8454ed2e65c35c334aa2a4c94534))
* **collections:** give rebuilt discover catalogs a form state ([329c4b9](https://github.com/9000000/aiometadata/commit/329c4b94703ce463b3bc26756c07cc3ff50463e4))
* **collections:** hold imported catalogs until the design is applied ([329c4b9](https://github.com/9000000/aiometadata/commit/329c4b94703ce463b3bc26756c07cc3ff50463e4))
* **collections:** import a collection from a link ([ba84f88](https://github.com/9000000/aiometadata/commit/ba84f88826de4ae388edefa05e1921fb0f28f2d1))
* **collections:** keep a folder that has no sources yet ([939a008](https://github.com/9000000/aiometadata/commit/939a008bba5d7dd02557ce1d8ba036abded3b546))
* **collections:** keep a personal PublicMetaDB list out of a shared catalog ([0f02825](https://github.com/9000000/aiometadata/commit/0f02825c58d81dbd44d7c2d41c4525f5c4bf77ee))
* **collections:** keep a picker selection when the filters change ([0211926](https://github.com/9000000/aiometadata/commit/0211926b7ef98ffe0079c3a1f7d551fd3da7c292))
* **collections:** keep Enter on a picker button doing that button's job ([de1aae9](https://github.com/9000000/aiometadata/commit/de1aae908f1a45e9211efe977b9173d8073d8f93))
* **collections:** keep ids joinable when a Fusion export prefixes them ([3849fd2](https://github.com/9000000/aiometadata/commit/3849fd25c67c07ed568e6abc1d6e7114c55de6f5))
* **collections:** keep the entry filter reachable once it is set ([4ecab06](https://github.com/9000000/aiometadata/commit/4ecab06984d17c8f64075fcb6ff2bb0ecda29e44))
* **collections:** keep the export payload to the fields Fusion expects ([3bf2fb0](https://github.com/9000000/aiometadata/commit/3bf2fb0e05a15bd269915d13af3b0c9e05e28c7e))
* **collections:** keep the genre when importing a Fusion export ([77150fc](https://github.com/9000000/aiometadata/commit/77150fcecf3bda4313252557c42fd36e4d7ea228))
* **collections:** label an imported source after its catalog, not its tile ([0d7b9a5](https://github.com/9000000/aiometadata/commit/0d7b9a53f809a263d4fc259f8b5b70075db68689))
* **collections:** let a Nuvio export drop the config id too ([22bc897](https://github.com/9000000/aiometadata/commit/22bc89741d804a0d59beafd66fcc3dcbcea4537e))
* **collections:** make routing Nuvio's own sources through the addon opt-in ([329c4b9](https://github.com/9000000/aiometadata/commit/329c4b94703ce463b3bc26756c07cc3ff50463e4))
* **collections:** make the builder usable on a phone ([b660329](https://github.com/9000000/aiometadata/commit/b66032939a8c5c60f43c479c642426f7ea6d52a6))
* **collections:** make the builder usable on a phone ([6161ee0](https://github.com/9000000/aiometadata/commit/6161ee05cc649e31735a979a8fc06c4cc52952c4))
* **collections:** make the picker's filter chips reachable by keyboard ([d99804b](https://github.com/9000000/aiometadata/commit/d99804b6a61b44a148af65d5febb7faac6dbf0fe))
* **collections:** match a manifest catalog whose type differs only in case ([0e01e96](https://github.com/9000000/aiometadata/commit/0e01e962f43452a3a1344fa5dc291859e54dceaf))
* **collections:** match a retyped or MAL discover catalog to its manifest entry ([ba84f88](https://github.com/9000000/aiometadata/commit/ba84f88826de4ae388edefa05e1921fb0f28f2d1))
* **collections:** match a suffixed catalog on its original type, not its display type ([f74f571](https://github.com/9000000/aiometadata/commit/f74f57111841eee1558b9ea72bbe59c397cd3772))
* **collections:** move export out of the tab strip ([0207079](https://github.com/9000000/aiometadata/commit/0207079e740d4595d1677a0fe6bfd72a64b9212c))
* **collections:** move export out of the tab strip ([8d5c93d](https://github.com/9000000/aiometadata/commit/8d5c93d45209d13b11c3c4b8d7c702a129d301ae))
* **collections:** name an imported catalog after the tile carrying it ([296ee50](https://github.com/9000000/aiometadata/commit/296ee504114f5c8f306b72ce68e79b9dace8d9b6))
* **collections:** name an imported catalog after the tile carrying it ([bcfe903](https://github.com/9000000/aiometadata/commit/bcfe903b8c2e58d668c433eae951926d6b4f44d7))
* **collections:** name every list in the Unified Media Experience collection ([57d6e82](https://github.com/9000000/aiometadata/commit/57d6e82b256324f66ddce83d4558d6b7f2de23a9))
* **collections:** name Fusion's word in every alias hint ([fd691af](https://github.com/9000000/aiometadata/commit/fd691af4fa0f4aded8f7c7fa23a79345247859da))
* **collections:** name the Unified Media Experience lists as their services do ([0d7b9a5](https://github.com/9000000/aiometadata/commit/0d7b9a53f809a263d4fc259f8b5b70075db68689))
* **collections:** offer the catalog swap even when an import adds catalogs ([de0fdcd](https://github.com/9000000/aiometadata/commit/de0fdcd08a45a995b4e15da22a4c5debee3c2b10))
* **collections:** only ask for a genre where the catalog needs one, and start it on the declared default ([2cc967e](https://github.com/9000000/aiometadata/commit/2cc967efb29b08e6170ebce55d3e7b1266dae81c))
* **collections:** point a source problem at the folder holding it ([0c332bb](https://github.com/9000000/aiometadata/commit/0c332bb88144d5b9125a2e94078b249a53f088b1))
* **collections:** point an imported source at the id this manifest serves ([885a99b](https://github.com/9000000/aiometadata/commit/885a99b73866c9113af518afd1d2c8ac402c0105))
* **collections:** rebuild catalogs from a Nuvio collection file ([329c4b9](https://github.com/9000000/aiometadata/commit/329c4b94703ce463b3bc26756c07cc3ff50463e4))
* **collections:** rebuild merged, MDBList and FlixPatrol catalogs on import ([728dd8f](https://github.com/9000000/aiometadata/commit/728dd8f641c3b4b41fc8da6f85dd872383bb07f3))
* **collections:** rebuild TMDB collection sources on import ([6c72260](https://github.com/9000000/aiometadata/commit/6c72260b3437634afedea1d02061d1ebeed94aa6))
* **collections:** rebuild TMDB collection sources on import ([491a5c7](https://github.com/9000000/aiometadata/commit/491a5c74a0d1e1ca1e5cb0512d40c231122209c1))
* **collections:** recreate account catalogs from their id ([329c4b9](https://github.com/9000000/aiometadata/commit/329c4b94703ce463b3bc26756c07cc3ff50463e4))
* **collections:** reload the catalog list once a save lands ([ba84f88](https://github.com/9000000/aiometadata/commit/ba84f88826de4ae388edefa05e1921fb0f28f2d1))
* **collections:** route apply and close through the save gates ([c4e1376](https://github.com/9000000/aiometadata/commit/c4e1376d872a1a6f789f4fc62e3940ddd36e71a0))
* **collections:** route native sources one folder at a time ([ba84f88](https://github.com/9000000/aiometadata/commit/ba84f88826de4ae388edefa05e1921fb0f28f2d1))
* **collections:** say that saving does not reach the app ([168dd15](https://github.com/9000000/aiometadata/commit/168dd15da39c6f0d4f258f26870f195ccfedcee6))
* **collections:** say when the save cannot reach the server ([206ddf3](https://github.com/9000000/aiometadata/commit/206ddf318c3640771266a2c37ee03de4aee7768f))
* **collections:** stop a catalog waiting on an account reading as staged ([ed63504](https://github.com/9000000/aiometadata/commit/ed635049831701473ef30c8f6695cf0ee741b11f))
* **collections:** stop a Fusion export silently dropping most of a design ([329c4b9](https://github.com/9000000/aiometadata/commit/329c4b94703ce463b3bc26756c07cc3ff50463e4))
* **collections:** stop an import exceeding the catalog ceiling ([329c4b9](https://github.com/9000000/aiometadata/commit/329c4b94703ce463b3bc26756c07cc3ff50463e4))
* **collections:** stop an imported file rebuilding someone else's personal list ([69d87a7](https://github.com/9000000/aiometadata/commit/69d87a7518645ef749257948839114a06dada94f))
* **collections:** stop export notes reading as a missing catalog ([6f45940](https://github.com/9000000/aiometadata/commit/6f4594060c0d294b95bbda65c842f9231097263c))
* **collections:** stop offering starters there are none of ([e8c4ded](https://github.com/9000000/aiometadata/commit/e8c4dedf6664da5cc412ebd8f48929ab73954cea))
* **collections:** stop rebuilding a catalog that was deleted ([85a6082](https://github.com/9000000/aiometadata/commit/85a6082431963b428897b5d95f29f35d9669824a))
* **collections:** stop saying an empty folder is dropped ([edf4f8e](https://github.com/9000000/aiometadata/commit/edf4f8e2457a3080ffd630c555d45e73cae63a8b))
* **collections:** stop the builder reselecting what you already typed ([e45668b](https://github.com/9000000/aiometadata/commit/e45668b1df05cbe2842143f6b0ec1b83cb97a9f7))
* **collections:** stop the pointer stealing the picker's keyboard selection ([aafe970](https://github.com/9000000/aiometadata/commit/aafe97032c70fd7f0951981383295bc666819a84))
* **collections:** stop the preview clipping its own labels ([be8a84f](https://github.com/9000000/aiometadata/commit/be8a84fa2095d4ad9eb7368637c51c15616d85d1))
* **collections:** stop the preview clipping its own labels ([2e4e2b6](https://github.com/9000000/aiometadata/commit/2e4e2b6f2209ad552cba7251bcf32fdd9d4918d0))
* **collections:** stop the save shortcut firing from a nested dialog ([3fff28d](https://github.com/9000000/aiometadata/commit/3fff28d193a81455daacbc21ebc0cd819f0ea360))
* **collections:** undo only the delete it was offered for ([f71ecbb](https://github.com/9000000/aiometadata/commit/f71ecbb68c835ea670a5be71ae22c71adde7dce1))
* **collections:** wire the labels to their controls and make the empty states act ([5e1bd09](https://github.com/9000000/aiometadata/commit/5e1bd0963892f9069081d75266ba4ade511734d3))
* **config:** keep a large configuration savable ([96cd431](https://github.com/9000000/aiometadata/commit/96cd431b2d7e8a625bb8c6e9c42ba6ff1aa6169c))
* **config:** keep a large configuration savable ([a133856](https://github.com/9000000/aiometadata/commit/a13385697de5e01081aef682f03342cdd5f56d40))
* **config:** rate limit profile saves per configuration ([62343a3](https://github.com/9000000/aiometadata/commit/62343a3638db5c95d0d170209983a7b020bef509))
* **configure:** clear the frontend type errors ([7664308](https://github.com/9000000/aiometadata/commit/7664308420005822dfdb8480af5b386bb6a78723))
* **configure:** open a loaded configuration on its own URL ([642ab91](https://github.com/9000000/aiometadata/commit/642ab91e6daa5d6609fafea0e04db1b7ee6873a2))
* **configure:** sort the added timezones by offset in both DST seasons ([bb1eb6c](https://github.com/9000000/aiometadata/commit/bb1eb6c253e5bf3cc9965957923145a22823d48b))
* **dashboard:** filter logs in the buffer, not in the browser ([440856b](https://github.com/9000000/aiometadata/commit/440856bbdd8d9201b4e883be9dca6c5e8d8c3df9))
* **dashboard:** let an SSO instance reach the dashboard without an admin key ([133814e](https://github.com/9000000/aiometadata/commit/133814eaa9f8ae426dd3037051e16ff29f26b909))
* **dashboard:** populate Users tab stats from database and fix tab loading state ([64f7ed3](https://github.com/9000000/aiometadata/commit/64f7ed3514cbe6e75f73654a9aa4974f579e2945))
* **dashboard:** reach the accounts panel on mobile and report what its actions did ([bdb1e66](https://github.com/9000000/aiometadata/commit/bdb1e66b68790ebe266f28db66af2a3272312e77))
* **dashboard:** report heap usage against the limit V8 enforces ([ec183ff](https://github.com/9000000/aiometadata/commit/ec183ff4e415c5a5e4594ade7f32b6a4439ee2f7))
* **dashboard:** report image warming per run instead of per process ([37a4b72](https://github.com/9000000/aiometadata/commit/37a4b72850fd45a19814e232d4ae6f2862ea71f1))
* **dashboard:** say how to reach the dashboard when no admin key is set ([f43b5b5](https://github.com/9000000/aiometadata/commit/f43b5b5fc187a0ad4765b4abbc1d517dcb187234))
* **dashboard:** show every search provider in the performance tab ([ac8b53b](https://github.com/9000000/aiometadata/commit/ac8b53b25fe121a31eabf517abf9ce72b28320fb))
* **dashboard:** stop the cache clear from signing the operator out ([73dad82](https://github.com/9000000/aiometadata/commit/73dad82c66116cc813f20ef3e99187df46a88477))
* **discover:** sort digital releases by their digital date ([993ba39](https://github.com/9000000/aiometadata/commit/993ba391f305e0138699f97744d0729c56c441b1)), closes [#664](https://github.com/9000000/aiometadata/issues/664)
* **docs:** run self-hosted Jikan search on Typesense ([a5cda44](https://github.com/9000000/aiometadata/commit/a5cda44bd83d9fde35f9eabf2f22eceba606f3f1))
* **filters:** hide unrated titles at every content rating ([3f70c40](https://github.com/9000000/aiometadata/commit/3f70c40bf0e1d37d7fddf97ef2f40dc7b629bd6c))
* **filters:** keep hide-watched out of completed and history catalogs ([dbe40ed](https://github.com/9000000/aiometadata/commit/dbe40ed200945b3df3e2a728b8f232712438a304))
* further improvements to save configuration gating logic ([2151070](https://github.com/9000000/aiometadata/commit/215107025a0bfc6d26216785f89d69f13ed668f6))
* handle cached chunks better between addon updates ([6529450](https://github.com/9000000/aiometadata/commit/652945086ff7647fc7c402137b7f8f247dda060f))
* handle cached chunks better between addon updates ([e766e96](https://github.com/9000000/aiometadata/commit/e766e96bb8d4bad82083a9dfcad5bfcf741a8e85))
* **ids:** stop a series mapping answering a movie lookup ([225b4df](https://github.com/9000000/aiometadata/commit/225b4df0bea4456ed6e43cc61e3f71719bf76cf2))
* **image cache:** stop image provider connections piling up TLS sessions ([dbbd875](https://github.com/9000000/aiometadata/commit/dbbd8754ab9015fbd68fe97826b7243edcb62564))
* **integrations:** keep a connection without pressing save ([ed389dc](https://github.com/9000000/aiometadata/commit/ed389dcf210f965fb18cddc5bf59fbd01948600f))
* **integrations:** stop disconnect logging you out ([fe1cfe4](https://github.com/9000000/aiometadata/commit/fe1cfe48c39feecef1f47bdef101dd528fb770c2)), closes [#684](https://github.com/9000000/aiometadata/issues/684)
* **integrations:** stop disconnect logging you out ([c534137](https://github.com/9000000/aiometadata/commit/c534137583d4de8dad06c95bfabf9c766426632d)), closes [#684](https://github.com/9000000/aiometadata/issues/684)
* **jikan:** apply the rate limit settings set from the dashboard ([1c39dd2](https://github.com/9000000/aiometadata/commit/1c39dd2ce71e766acdaec5fca76bffc8924508de))
* **kitsu:** drop the expiring signature from cached Kitsu image urls ([#706](https://github.com/9000000/aiometadata/issues/706)) ([8a3af00](https://github.com/9000000/aiometadata/commit/8a3af00aad62841f715b5b4c58a04b15a917b552))
* **kitsu:** drop the expiring signature from cached Kitsu image urls ([#706](https://github.com/9000000/aiometadata/issues/706)) ([e167975](https://github.com/9000000/aiometadata/commit/e16797513b6992e732dbefc02d279cc9d5594ce8))
* **letterboxd:** restore importing lists and watchlists by URL ([98afaa1](https://github.com/9000000/aiometadata/commit/98afaa1a73c156df09137746d11584a19e1e2cc9))
* **mal:** back off when MyAnimeList refuses a burst with 405 ([b4b4668](https://github.com/9000000/aiometadata/commit/b4b4668840b47cd0b4243b531efb281cb65d4d37))
* **mal:** carry the MAL age rating onto catalog items ([38e7588](https://github.com/9000000/aiometadata/commit/38e7588beff264443091675398f547e4eb6b3d30))
* **mal:** stop the genres catalog hiding everything that is not a TV series ([55192ab](https://github.com/9000000/aiometadata/commit/55192ab52abd982467de22604776d5cbe189d5fd))
* **manifest:** emit one genre extra per catalog ([3916d0b](https://github.com/9000000/aiometadata/commit/3916d0bb1b3ad3a7e77d4d3fbed93729c55a26c6))
* **manifest:** type the translation and catalog-type lookups, drop dead locals ([3916d0b](https://github.com/9000000/aiometadata/commit/3916d0bb1b3ad3a7e77d4d3fbed93729c55a26c6))
* **mdblist:** honor the built-in API key outside quick add ([2bc6471](https://github.com/9000000/aiometadata/commit/2bc6471c59f676660dc1c5601ff042bec4d2eb6c))
* **meta:** ask both providers for the viewer's own age rating ([f063544](https://github.com/9000000/aiometadata/commit/f063544579c1bc5a4fb378a5297f66d17a6a3b10))
* **meta:** build deep links from the identifier the client installed ([097c676](https://github.com/9000000/aiometadata/commit/097c67653463a599d8d0cbda61c390e899526935))
* **meta:** emit director and writer as string arrays per the Stremio spec ([f21941c](https://github.com/9000000/aiometadata/commit/f21941cc5e1de9235752a18eccf20cc5d758ca74))
* **meta:** emit director and writer as string arrays per the Stremio spec ([8d90666](https://github.com/9000000/aiometadata/commit/8d9066631688e704ec88fca63be2e85ba3f970bc))
* **meta:** emit director and writer as string arrays per the Stremio spec ([74604a6](https://github.com/9000000/aiometadata/commit/74604a6153e4107d2d533328bc06160a11c65cca))
* **meta:** emit director and writer as string arrays per the Stremio spec ([ceb7b9c](https://github.com/9000000/aiometadata/commit/ceb7b9c5b5b89f9fa5c8d385bf9e5f7b3cbbe096))
* **meta:** keep IMDB episode ids when a season is missing from Cinemeta ([89be187](https://github.com/9000000/aiometadata/commit/89be1873d1feec96b1df885aa869bcf945b781ec))
* **meta:** read cached credits as arrays ([d2e40da](https://github.com/9000000/aiometadata/commit/d2e40da30bf3be1a32518db2768943ce0e13bd56))
* **meta:** read cached credits as arrays ([bafec6e](https://github.com/9000000/aiometadata/commit/bafec6e86a44455bc9e377baa2c50921c07dee14))
* **meta:** use TMDB original-language art when no English art exists ([5bd73d3](https://github.com/9000000/aiometadata/commit/5bd73d33ae6d5d425f2898f1e42465f06e30a3e2))
* **movielens:** fix movielens sign up url ([76d3754](https://github.com/9000000/aiometadata/commit/76d37548d55ee4a804f7dbbf53231c4564433438))
* **movielens:** offer the hide watched and unreleased overrides ([5906774](https://github.com/9000000/aiometadata/commit/5906774501531208f6f81e2ab99046cbe6f9ea7d))
* **movielens:** rate every part of a multi-part film and skip malformed IMDb ids ([78e095f](https://github.com/9000000/aiometadata/commit/78e095f151eacdde1ea80aab6283a91b7f923c0b))
* **movielens:** resolve conflict between maxYear and maxFutureDays ([a1eb9ee](https://github.com/9000000/aiometadata/commit/a1eb9ee1c1112dba41fceeac76606e1deee11924))
* **movielens:** resolve conflict between maxYear and maxFutureDays ([f8367d3](https://github.com/9000000/aiometadata/commit/f8367d37514ed1c18695c74fe153a1018564d8f6))
* **movielens:** say which sync numbers come from MovieLens ([15a819f](https://github.com/9000000/aiometadata/commit/15a819f4c42586f661d86c80355d8dbe676afddf))
* **movielens:** stop missing imported MDBList ratings ([b4eff78](https://github.com/9000000/aiometadata/commit/b4eff785fa65429da4d605cd6bbbc27bc61613d9))
* **movielens:** sync anime film ratings from Simkl ([a71b65f](https://github.com/9000000/aiometadata/commit/a71b65f415f37b7ea80ad5d85818272d97fdf480))
* **oidc:** ask for the scopes the provider advertises ([3bb4211](https://github.com/9000000/aiometadata/commit/3bb42114982bacb06ba962497ba0053c2312a42f)), closes [#668](https://github.com/9000000/aiometadata/issues/668)
* **oidc:** match an email in the permission mapping without regard to case ([3bb4211](https://github.com/9000000/aiometadata/commit/3bb42114982bacb06ba962497ba0053c2312a42f))
* **oidc:** stop trusting an address the provider says is unverified ([3bb4211](https://github.com/9000000/aiometadata/commit/3bb42114982bacb06ba962497ba0053c2312a42f))
* only require mdblist keys when mdblist catalogs are enabled ([9343f70](https://github.com/9000000/aiometadata/commit/9343f7083aa6502e1f01b0767c22975c18710752))
* **search:** apply the content rating to every search engine ([c0c5d42](https://github.com/9000000/aiometadata/commit/c0c5d421573b2f8e2523d43cc1c6eba1a319d6d4))
* **search:** drop adult results the IMDb path let through ([bf309e9](https://github.com/9000000/aiometadata/commit/bf309e90afa1b6b2564feecdf71906d98e49330f))
* **search:** flag Trakt search as VIP only ([b39f8cf](https://github.com/9000000/aiometadata/commit/b39f8cf82091fc89a7cc30edee912645bf992394))
* **search:** keep MDBList's ranking through the batch enrichment ([cebecc8](https://github.com/9000000/aiometadata/commit/cebecc8fe43f4a5fa00cad9bb672e85fc8ce043f))
* **search:** let OpenRouter AI search run without credits ([b294d84](https://github.com/9000000/aiometadata/commit/b294d84aea9e6d4d85e123bb65689c5857793046))
* **search:** make Simkl search opt-in ([627c874](https://github.com/9000000/aiometadata/commit/627c874d46c0ea9e1361613ac4a43b820ba3127c))
* **search:** request posters at w600_and_h900_bestv2 like every other path ([bc24573](https://github.com/9000000/aiometadata/commit/bc24573fb7db9760f61bb2102a8a3a2ad44f5304))
* **search:** resolve TVDB certification when an age cap is set ([95f9f49](https://github.com/9000000/aiometadata/commit/95f9f49896d8efba81e554602a7817fcbaa4c17c))
* **search:** resolve TVDB certification when an age cap is set ([adc7001](https://github.com/9000000/aiometadata/commit/adc700180e88015a99c0aadb7dd87bf2842a7f74))
* **search:** stop stripping non-Latin IMDb suggestion queries ([10e2eed](https://github.com/9000000/aiometadata/commit/10e2eedde3a0ac6493d3ac917ad65c759f6eae87))
* **server:** decide compression by the route express delivers ([350234a](https://github.com/9000000/aiometadata/commit/350234aeae30dc4fc8eaa47f5a71dd928ab97188))
* **server:** keep the compression module's locals file-local ([3f538b8](https://github.com/9000000/aiometadata/commit/3f538b86f148dbab50c5062bd8a81255a8171d27))
* **settings:** correct the Jikan defaults shown in the dashboard ([1c39dd2](https://github.com/9000000/aiometadata/commit/1c39dd2ce71e766acdaec5fca76bffc8924508de))
* **settings:** land on the section instead of the page top ([83ec317](https://github.com/9000000/aiometadata/commit/83ec31722c62d4c85c1796dd997273a73f1bd381))
* **settings:** register TRUST_PROXY_HOPS in the settings registry ([187ff67](https://github.com/9000000/aiometadata/commit/187ff671057192a2ddfe41c95399c257a3636720))
* **simkl:** apply SIMKL_ACTIVITIES_TTL without a restart ([dbe40ed](https://github.com/9000000/aiometadata/commit/dbe40ed200945b3df3e2a728b8f232712438a304))
* **simkl:** close the gaps in the PIN flow ([0a95c31](https://github.com/9000000/aiometadata/commit/0a95c3161ca90459e49a46f4098c5f53be5d2da3))
* **simkl:** drop watchlist items that moved to another status ([07e852b](https://github.com/9000000/aiometadata/commit/07e852b8196d65d2b60fc6b0678bbb2ba6a390f1))
* **simkl:** fetch sync/activities with GET ([f3b68de](https://github.com/9000000/aiometadata/commit/f3b68ded4ff53d850ed179bd3316fc59e81d6edd))
* **simkl:** keep catalog TTLs off the shared watching blob ([f3b68de](https://github.com/9000000/aiometadata/commit/f3b68ded4ff53d850ed179bd3316fc59e81d6edd))
* **simkl:** lower the activity check default to 30 minutes ([f3b68de](https://github.com/9000000/aiometadata/commit/f3b68ded4ff53d850ed179bd3316fc59e81d6edd))
* **simkl:** show English titles in the watchlist catalogs ([28c1637](https://github.com/9000000/aiometadata/commit/28c16374cb6188940be01a30cfe254c0a5e9d4ea)), closes [#688](https://github.com/9000000/aiometadata/issues/688)
* **sso:** bind an OIDC sign-in to the browser that started it ([3c531e1](https://github.com/9000000/aiometadata/commit/3c531e1a73e9cf5765987ae6e13b5e01a49801e9))
* **sso:** bound how many sign-in failures the log will keep and read ([7b781dd](https://github.com/9000000/aiometadata/commit/7b781dd018726dd213195dd49d854c397514470d))
* **sso:** close the window where a sign-in outlives the block that hit it ([8d5ca17](https://github.com/9000000/aiometadata/commit/8d5ca178c0aff0886395fd124095d6722b61b6f4))
* **sso:** delete the account row before sweeping its sessions ([255a2f5](https://github.com/9000000/aiometadata/commit/255a2f58c544551478adecbca778f323964e81f8))
* **sso:** delete the payloads a trimmed failure index leaves behind ([89afe3f](https://github.com/9000000/aiometadata/commit/89afe3fcc1e7474975bde1a729c9b8f9d9bedafa))
* **sso:** destroy the minted session when the block re-read throws ([648f323](https://github.com/9000000/aiometadata/commit/648f3230c4e6e85ebb22627f9b0c8bcff3b0c5b5))
* **sso:** honour AUTH_SIGNIN_FAILURE_LOG_MAX when listing failures ([8eeb5e3](https://github.com/9000000/aiometadata/commit/8eeb5e35d9e444a4870fd5bb9151c0dc4d26ff27))
* **sso:** keep a rate-limited request refused when recording it fails ([ff3b798](https://github.com/9000000/aiometadata/commit/ff3b7988843b841e0761e6ae9fa748dcef7a7247))
* **sso:** keep refusals visible and sign-ins tied to a live account ([e0f5e46](https://github.com/9000000/aiometadata/commit/e0f5e46aab857973e00ad71e2fa4abe3e93a0032))
* **sso:** make account revocation authoritative again ([884430d](https://github.com/9000000/aiometadata/commit/884430dbd138b6a45afa9d704b5f5572289031b4))
* **sso:** make the self-demotion guard model a settings reset correctly ([9a22467](https://github.com/9000000/aiometadata/commit/9a224678879293089cb1e447ccfa902013800b9c))
* **sso:** point an unreadable mapping at the setting, not at every account ([4f3bbce](https://github.com/9000000/aiometadata/commit/4f3bbce5524d7b0cb82bbb6c302fec0ff364c408))
* **sso:** rate limit sign-in by an address the client cannot forge ([00911bf](https://github.com/9000000/aiometadata/commit/00911bf4516f3aa266f3aed96820ff2c180d4b01))
* **sso:** refuse a post-sign-in redirect that leaves the instance ([976f513](https://github.com/9000000/aiometadata/commit/976f51318853b319d2a70cb5a3c455acaead008b))
* **sso:** refuse the login when the group mapping cannot be read ([3540713](https://github.com/9000000/aiometadata/commit/3540713995c0eb4820d086bcf7f7b057f66e4ab8))
* **sso:** report a block whose session sweep failed as saved, not failed ([5ebbff3](https://github.com/9000000/aiometadata/commit/5ebbff3c7544806a93d0cea0c3e09cf27e1ac5a4))
* **sso:** report the sessions a failed sweep did destroy ([ad78e04](https://github.com/9000000/aiometadata/commit/ad78e0475f1f784d584ce034b4dff445eb080772))
* **sso:** say what a settings change does to other admins, per outcome ([d668a2b](https://github.com/9000000/aiometadata/commit/d668a2b8b27775de837e474b167da187cb9c5cb3))
* **sso:** separate the parts of a multi-outcome warning with semicolons ([b50d4c3](https://github.com/9000000/aiometadata/commit/b50d4c30c1326769906a844a9f8c4c50b3f41480))
* **sso:** stop a full refusal log hiding every provider error ([1ef32b4](https://github.com/9000000/aiometadata/commit/1ef32b4563a2bfb1c3cc293387690270c6f46f4d))
* **sso:** stop unauthenticated attempts evicting recorded refusals ([48a84c7](https://github.com/9000000/aiometadata/commit/48a84c7a76b2f4c9464ebc81268b87604b3f774f))
* **sso:** tell a refused account apart from an unrecorded one ([ea4aebf](https://github.com/9000000/aiometadata/commit/ea4aebf9fbd63c074d2711aeb197dbf1c2b725ba))
* **sso:** tell an admin what a settings change would actually do ([515227c](https://github.com/9000000/aiometadata/commit/515227ce07769ad0cc885e40b53ea715a5dbcd8d))
* **sso:** warn that an unreadable mapping refuses everyone, not just admins ([3fb6d57](https://github.com/9000000/aiometadata/commit/3fb6d57bac8838c70095a53755d6facf0ffd0c24))
* stop forcing a vote count floor on discover catalogs ([61334bc](https://github.com/9000000/aiometadata/commit/61334bcee9eb54eaf63c7b75ffd3109b523bebb6))
* **tmdb:** cache movie and series detail responses ([cc1b345](https://github.com/9000000/aiometadata/commit/cc1b3453b8da751af9ffbcbb73d159e2544fee92))
* **tmdb:** list every language the discover filter accepts ([51d9cb0](https://github.com/9000000/aiometadata/commit/51d9cb0a7a7a6f00ddcdcb0e6844b9ef75ff73f2)), closes [#659](https://github.com/9000000/aiometadata/issues/659)
* **tmdb:** never request a rendition larger than the asset ([032cb08](https://github.com/9000000/aiometadata/commit/032cb08e6491f7f2462c530b061596759b2b0762))
* **trailers:** derive trailerStreams instead of caching it ([15e111c](https://github.com/9000000/aiometadata/commit/15e111ce4928055f8ba37d626be1d584bd00228e))
* **trailers:** honour the language setting for TVDB trailers ([a68e530](https://github.com/9000000/aiometadata/commit/a68e530007020aac09ee63549ada14592506c2b1))
* **trailers:** honour the language setting for TVDB trailers ([7f941dc](https://github.com/9000000/aiometadata/commit/7f941dcc86449239b8e607c869906d7a1fd81cf0))
* **trailers:** match the user's language on TVDB's own coding ([d1e3382](https://github.com/9000000/aiometadata/commit/d1e3382d1e418f6f900640f2638462c0c8cdc691))
* **trakt:** answer the hide-watched filter from the last known set while Trakt is rate limited ([02262d9](https://github.com/9000000/aiometadata/commit/02262d97c421e65fdbcd3bcb5f2a9d6ae07bc67f))
* **trakt:** serve the integration logo from our own assets ([b507ac1](https://github.com/9000000/aiometadata/commit/b507ac1b124d38bc046d5c075a7f1554c16ab6d5))
* **translations:** try the other Portuguese before falling back to English ([fb24fcc](https://github.com/9000000/aiometadata/commit/fb24fcc4d8651a8f16c5e54b1f75d17484c0e17d))
* **tsconfig:** put addon files in a project the editor can find ([4c4f7ce](https://github.com/9000000/aiometadata/commit/4c4f7cee7fab5a9c4080ddb178e06f859d15d446))
* **tvdb:** find the right entity in a remote id lookup ([3e04885](https://github.com/9000000/aiometadata/commit/3e04885813603ecc6ae16809908e96ecfe3d112a))
* **tvdb:** retry TVDB after a failed login ([999a213](https://github.com/9000000/aiometadata/commit/999a213bbc3bcaeaf8bef8541ec5b081bb57d5e4))
* **ui:** make the support link a native button in the settings nav ([5ea6a5f](https://github.com/9000000/aiometadata/commit/5ea6a5f4dc2fa9d3361fb73cb19d88d968228005))
* **warmer:** register IMAGE_WARM_PROXY_BASE ([1dc2481](https://github.com/9000000/aiometadata/commit/1dc248196b9540d1327edecf0729470a1b95c543))
* **warmer:** stop refetching every rendered poster each cycle ([a0992ff](https://github.com/9000000/aiometadata/commit/a0992ff552c904c35078092247f883d502195e87))
* **warming:** keep forced warms from shifting the schedule ([b41b329](https://github.com/9000000/aiometadata/commit/b41b329bccd8aa450b683af5903be955e6a70329))
* **warming:** restore the schedule reset on a forced warm ([5f6c6a9](https://github.com/9000000/aiometadata/commit/5f6c6a9166ef72902a8a12592eb0970f48f36f99))
* **warmup:** warm the custom art URLs clients actually request ([0d8ceaf](https://github.com/9000000/aiometadata/commit/0d8ceafcf99ea3250b78ee9fa5e7b90d44bde97b))
* **watch-tracking:** say when progress is recorded, once, instead of per service ([0b70cb4](https://github.com/9000000/aiometadata/commit/0b70cb42cbd769da134372a4f2d30397c557e853))


### Performance Improvements

* **anime:** cache episode pages separately instead of the whole list ([7faba54](https://github.com/9000000/aiometadata/commit/7faba543bbc9cd9ab581d6ede594e7a6161d3b9b))
* **cache:** optimize Redis requests by adding L1 RAM caches and batching ([413434c](https://github.com/9000000/aiometadata/commit/413434cee02ca323d045f4e8fa24d7a2a5367ad4))
* **cache:** rebuild catalogs before they expire ([946a795](https://github.com/9000000/aiometadata/commit/946a795c2f6897305b7225813fcc352c9730150b))
* **collections:** stop restringifying the draft on every parent render ([b2f9a24](https://github.com/9000000/aiometadata/commit/b2f9a24a79708e9ba2b76c983a27a02b12f7470e))
* **dashboard:** skip Redis queries for users and heatmap when in LITE_MODE ([0ce388c](https://github.com/9000000/aiometadata/commit/0ce388c647baffc11d8a6cd1f38a4a6375b7c23e))
* **server:** compress http responses ([d62c91c](https://github.com/9000000/aiometadata/commit/d62c91c39222a248f0a075f3f9c5b93ea0861676))
* **sso:** index sessions per account instead of scanning the keyspace ([8c82f1b](https://github.com/9000000/aiometadata/commit/8c82f1b05db78ba4f29a464b04a1adf1ce373725))
